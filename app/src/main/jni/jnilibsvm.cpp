...
extern "C" void Java_com_night_troly_activities_MainActivity_jniSvmTrain(JNIEnv *env, jobject obj, jstring cmdIn){
...
extern "C" void Java_com_night_troly_activities_MainActivity_jniSvmPredict(JNIEnv *env, jobject obj, jstring cmdIn){
	const char *cmd = env->GetStringUTFChars(cmdIn, 0);
...
extern "C" void Java_com_night_troly_activities_MainActivity_jniSvmScale(JNIEnv *env, jobject obj, jstring cmdIn){
	const char *cmd = env->GetStringUTFChars(cmdIn, 0);
	debug("jniSvmScale cmd = %s", cmd);
...
*/
extern "C" JNIEXPORT int JNICALL Java_com_night_troly_activities_MainActivity_testInt(JNIEnv * env, jobject obj){
	return 5566;
}

extern "C" void Java_com_night_troly_activities_MainActivity_testLog(JNIEnv *env, jobject obj, jstring logThis){
