...
namespace svmscale {
    void exit_with_help()
    {
    	...
    	"-o output_filename: save the output filename \n"
    ...
    void output_target(FILE *f_output,double value);
    void output(FILE *f_output,int index, double value);
    ...
    void output(FILE *f_output, int index, double value)
    {
    	...
    	if(value != 0)
    	{
    		fprintf(f_output,"%d:%g ",index, value);
